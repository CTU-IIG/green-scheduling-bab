...
private:
	...
	unsigned int N_robj;
    escs::Stopwatch mStopwatch;
    optional<chrono::milliseconds> mTimeLimit;
...
public:
	...
	Genetic(std::mt19937_64 random, optional<chrono::milliseconds> timeLimit) :
		unif_dist(0.0,1.0),
		N_robj(0),
...
protected:
	...
	****************************************************/
	...
	StopReason stop_critera()
	{
		...
		if (mStopwatch.timeLimitReached(mTimeLimit)) {
